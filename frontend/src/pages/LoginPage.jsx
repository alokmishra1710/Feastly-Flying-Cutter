...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    if (!token) { addToast("Please complete the reCAPTCHA", "error"); return; }
    setLoading(true);
    try {
  ...
  const handleForgotPassword = async (e) => {
    ...
    setResetting(true);
    try {
      await forgotPassword(email, newPwd, token);
            ...
            {mode === "login" ? (
              <>
                ...
                <form onSubmit={handleLogin} className="auth-form">
                  ...
                  <ReCAPTCHA ref={recaptchaRef} sitekey="6LdVFaYsAAAAAP-lgTe91FaWsanq-mAX83GG3whZ"
                    theme="dark" style={{ marginBottom: "1rem" }} />
                ...
                <p className="auth-switch" style={{ marginTop: "8px" }}>
                  ...
                  <button className="auth-link" style={{ background: "none", border: "none", cursor: "pointer", padding: 0 }}
                    onClick={() => { setMode("forgot"); recaptchaRef.current?.reset(); }}>
                    Reset it here
                  </button>
                </p>
              </>
              ...
              <>
                ...
                <form onSubmit={handleForgotPassword} className="auth-form">
                  ...
                  <button type="submit" className="btn-submit" disabled={resetting}>
                    {resetting ? <><span className="spinner" /> Resetting…</> : "Reset Password"}
                  </button>
                </form>
                ...
                <p className="auth-switch">
                  ...
                  <button className="auth-link" style={{ background: "none", border: "none", cursor: "pointer", padding: 0 }}
                    onClick={() => { setMode("login"); recaptchaRef.current?.reset(); }}>
                    Back to Sign In
                  </button>
                </p>
              </>
